...
const uint8_t GARAGE_WALLS_ID            = 58;
const uint8_t STAIRS_SCONES_ID           = 59;
const uint8_t BEDROOM_ID                 = 60;
...
const uint8_t LIGHTS_OUTSIDE_1_ID        = 68;
const uint8_t LIGHTS_OUTSIDE_2_ID        = 69;
const uint8_t HOUSE_OUTSIDE_ID           = 70;
const uint8_t ATTIC_ID                   = 71;
...
{GARAGE_WALLS_ID,         "garaż ściany",          5, false},            
{STAIRS_SCONES_ID,        "kinkiety schody",       4, false},    
{BEDROOM_ID,              "sypialnia S1",          3, false},    
{BEDROOM_BED_ID,          "sypialnia łóżko",       2, false},        
{HALL_UP_1_ID,            "góra hol sufit S1",    14, false},    
{HALL_UP_2_ID,            "góra hol sufit S2",    15, false},    
{DRESSING_TABLE_ID,       "sypialania toaletka",  16, false},   
...
OneButton garage_walls(A8,true);
OneButton stairs_scones(A9,true);
OneButton bedroom(A10,true);
OneButton bedroom_bed(A11,true);
OneButton hall_up_b1(A12,true);
OneButton hall_up_b2(A13,true);
OneButton dressing_table(A14,true);
